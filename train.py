...
def main():
    ...
    data_root = r'D:/team/alexnet learning/deep-learning-for-image-processing-master-juanji-msa/data_set/fanqie'
    ...
    optimizer = optim.AdamW(net.parameters(), lr=0.0001, weight_decay=0)
    scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='max', patience=10, factor=0.5)

    # 早停参数设置
    epochs = 100
    patience = 20 # 允许连续不提升的epoch数
    best_acc = 0.0
